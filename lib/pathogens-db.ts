...
export const PATHOGENS_DB: Record<string, PathogenDetails> = {
  'VCH-01': {
    ...
    icon: 'coronavirus',
    prevention: [
      'Deploy advanced sub-micron Point-of-Use (POU) filtration (reverse osmosis or absolute 0.2 micron).',
      'Maintain strict municipal sewage isolation and hyperchlorination protocols.',
      'Administer Oral Cholera Vaccines (OCV) in endemic and high-risk zones.'
    ],
    stats: {
  ...
  'STM-02': {
    ...
    icon: 'bug_report',
    prevention: [
      'Implement sub-micron carbon block filtration barriers (0.2 micron rating).',
      'Enforce strict food-handler hygiene regulations and waste separation.',
      'Promote vaccination (Vi-TCV conjugate vaccine) for high-exposure risks.'
    ],
    stats: {
  ...
  'GIA-03': {
    ...
    icon: 'microbiology',
    prevention: [
      'Utilize absolute 1-micron sediment or carbon block filtration (cysts are highly chlorine-resistant).',
      'Apply high-intensity UV irradiation (>10 mJ/cm²) as primary municipal barrier.',
      'Employ ozone disinfection (CT value > 1.5 mg·min/L) for reservoir outputs.'
    ],
    stats: {
  ...
  'LEG-04': {
    ...
    icon: 'air',
    prevention: [
      'Establish hyperchlorination (2-6 mg/L free chlorine) or monochloramine loops in water distribution.',
      'Perform thermal shock treatment (flush system at >70°C for 30 minutes).',
      'Install absolute 0.2 micron point-of-use filters on showers and taps in medical facilities.'
    ],
    stats: {
  ...
  'DYS-05': {
    ...
    icon: 'water_damage',
    prevention: [
      'Enforce standard free chlorine dosing (0.5 mg/L free chlorine with 30 min contact time).',
      'Implement multi-layer sand filtration or ultrafiltration for agricultural runoffs.',
      'Prohibit untreated sewage or manure discharge near potable water aquifers.'
    ],
    stats: {
