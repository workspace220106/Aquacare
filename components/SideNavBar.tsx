...
export default function SideNavBar() {
  ...
  return (
    <motion.nav 
      ...
      className="fixed left-0 top-0 h-full w-64 border-r border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900 font-['Space_Grotesk'] text-sm flex flex-col py-6 z-[60] pointer-events-auto"
    >
      {/* Brand Header */}
