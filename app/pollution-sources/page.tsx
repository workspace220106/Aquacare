    ...
    <div className="flex-1 overflow-y-auto p-margin md:p-xl flex flex-col gap-lg relative z-10 scroll-smooth h-full bg-zinc-50/50">
      ...
      >
        ...
        >
          ...
          <div>
            <div className="font-headline-lg text-[80px] font-black leading-none tracking-tighter text-zinc-900 mb-2 group-hover:scale-105 transition-transform origin-left duration-500">{loading ? '...' : data?.globalToxicityIndex?.toFixed(1) || '84.2'}<span className="text-headline-md text-zinc-400">%</span></div>
            <div className="h-[1px] w-full bg-gradient-to-r from-zinc-200 via-zinc-200 to-transparent my-6"></div>
            <p className="font-body-md text-sm text-zinc-600 mb-6 leading-relaxed">Overall concentration of verified pollutants across monitored watersheds has increased by <strong className="text-zinc-900">{(Math.random() * 2 + 1).toFixed(1)}%</strong> in the last 72 hours.</p>
            <motion.button 
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="relative overflow-hidden bg-zinc-900 text-white font-label-md text-sm font-bold px-4 py-3.5 rounded-xl uppercase tracking-widest hover:bg-zinc-800 transition-all w-full shadow-md hover:shadow-lg group/btn"
            >
        ...
        >
          <div className="flex justify-between items-start border-b border-zinc-100 pb-6 mb-6">
            ...
            <div className="text-right">
              <div className="font-headline-lg text-[40px] font-black text-red-600 leading-none drop-shadow-[0_2px_10px_rgba(220,38,38,0.1)]">{loading ? '...' : data?.industrial?.loadPercentage || '42'}%</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 flex-1">
            <div className="flex flex-col justify-center">
              <p className="font-body-md text-sm text-zinc-600 mb-8 leading-relaxed">Direct discharge from manufacturing and processing facilities. Primary contributors include heavy metals, synthetic solvents, and thermal pollution.</p>
            ...
            <div className="relative h-64 md:h-auto border border-zinc-200 rounded-xl overflow-hidden bg-zinc-100 shadow-inner group-hover:shadow-[0_0_20px_rgba(0,0,0,0.05)] transition-shadow">
              <img alt="Industrial area satellite view" className="w-full h-full object-cover opacity-90 hover:opacity-100 transition-opacity duration-500 hover:scale-105" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBRYLuzr-ivYu6zvQGrvWjb83wbCaTJlkZbTtALSeaRz6PrtRWS6LAhfHd6Lip8Ha93vPTd82Tu6LDePEiqvJntTzOLmrasKMmoDhmtOOK3Lc2hqUZdgD_nCWqWfOV1vU9OMvNJFCmB9gx0woDPr2US8ukmoy93hEPXj6W7U4w-RpTnG5WESFH7YfpCIDlJ_MNtk1KeWlyLdE7i0ARYZu2nkUjg7z3QJVtq1x49eJ4C4dVLQ4-y_RMd3FNHaiH8fC4n4QCSHEjMH_gG"/>
              <div className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent pointer-events-none"></div>
              <div className="absolute bottom-0 left-0 right-0 p-4 backdrop-blur-sm bg-zinc-900/85 border-t border-white/10">
